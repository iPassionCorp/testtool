...
public class BillingHeader  implements java.io.Serializable {
    ...
    public BillingHeader(String uttxrectype, String uttxseq, String uttxeffectivedate, String uttxfiledate, String uttxmerid, String uttxmername, String uttxcompacno, String uttxservicetype, String uttxbankcode, String uttxrecsize, String uttxfiletype, String filler) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BillingHeader) ) return false;
		 BillingHeader castOther = ( BillingHeader ) other; 
