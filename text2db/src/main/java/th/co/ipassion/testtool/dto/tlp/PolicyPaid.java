...
public class PolicyPaid implements java.io.Serializable{
    ...
    public void setBranchpay(String branchpay) {
        this.branchpay = branchpay;
    }
    ...
    public void setPartnersend(String partnersend) {
        this.partnersend = partnersend;
    }
}
